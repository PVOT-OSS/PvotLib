...
// AOSP builds the library modules from source as their own Soong modules, and
// generateBp cannot resolve project dependencies. Run it with -PgenerateBp so it
// only walks the external Maven graph.
val generatingBp = providers.gradleProperty("generateBp").isPresent
